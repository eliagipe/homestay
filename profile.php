    ...
    <div class="place">
        ...
        <div class="places">
          ...
          <div class="input-container">
            <input type="file" id="real-input" name="real-input">
            <button class="browse-btn">Browse Files</button>
            <span class="file-info">Upload your criminal record</span>
            <p><a href="profiledb.php" class="long-button hollow"> Upload criminal record</a></p>     
          </div>
        </div>
      </div>
...
<section class="section conteiner preferences">
  ...
  <div class="item3"><p><input type="submit" class="long-button hollow" value ="Save changes"></p></div>
</section>
</form>
