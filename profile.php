...
<script>
  ...
  <section class="section conteiner private-information">
    ...
    <form id="profile" class="profile" action="validateprofileS.php"method="post" enctype="multipart/form-data">
      <div class="place">
  ...
  <section class="section conteiner private-information">
    ...
    <div class="item3"><p><input type="submit" class="long-button hollow" value ="saved" name="addinfo" id="addinfo"></p></div>
  </section>
</form>
