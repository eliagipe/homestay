...
=======
      <form id="register" class="register" action="return false" onsubmit="return false" method="post">
>>>>>>> 4ba2b770430bcb55931df70f89b7fce83d8b1ee5
...
=======
          ...
          <div id="result"></div>
          <p><button class="button hollow" onclick="validatep(document.getElementById('password').value, document.getElementById('repeatPassword').value);">Register</button></p> 
>>>>>>> 4ba2b770430bcb55931df70f89b7fce83d8b1ee5
         
        </form>
        <script>
        function validatep(password, repeatPassword)
        {
            $.ajax({
                url: "validateregister.php",
                type: "POST",
                data: "password="+password+"&passwordrepeat="+repeatPassword,
